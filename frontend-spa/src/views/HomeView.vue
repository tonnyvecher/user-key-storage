    ...
    <div class="app">
      <header class="app__header">
        ...
        <p class="app__subtitle">
          Введите <code>userId</code> (UUID) и получите профиль, роли с проверкой подписи и результат доступа через
      ...
      <section class="grid">
        <div class="card">
          ...
          <p class="hint">
            Чувствительные поля (телефон / дата рождения) хранятся в БД в зашифрованном виде, а здесь уже отображаются
        ...
        <div class="card">
          ...
          <p class="hint">
            Для каждой роли проверяется криптографическая подпись (HMAC) через ключ из Vault.
